...
const WriteOberservableProperty: React.FC<UnitOfMeasurementProps> = ({
    rowData,
    setChanges,
    setMenuOpen,
    requestMethod,
    ...
    function validateForm() {
        ...
        if (!state.datatype?.trim()) {
            setAlertMessage('datatype is required.');
            return false;
        }
        return true;
    }
    ...
    useEffect(() => {
        if (nameTransition || urlTransition || descriptionTransition) {
    ...
    }, [nameTransition, urlTransition, descriptionTransition]);
        ...
        <>  
            ...
            <div className="mb-4">
                <label className="form-label">Name*
                    <ToolTip
                        title="name"
                        message="The unique identifier for the observable property name. This is required."
            ...
            <div className="mb-4">
                <label className="form-label">URL*
                    <ToolTip
                        title="url"
                        message="The unique identifier for the observable property URL. This is required."
                        items={{ url: '(str) e.g: "http://qudt.org/vocab/quantitykind/Temperature"' }}
                    />
                </label>
                <input
            ...
            <div className="mb-4">
                <label className="form-label">Description*
                    <ToolTip
                        title="description"
                        message="The description for the observable property. This is required."
                        items={{ description: '(str) e.g: "The degree of hotness or coldness of a body or environment."' }}
                    />
                </label>
                <input
                    className={`form-input ${descriptionTransition ? 'form-input-error' : 'form-input-error-fade'}`}
                    id="description"
                    type="text"
                    name="description"
            ...
            <div className="mb-4">
                <label className="form-label">Data Type*
                    <ToolTip
                        title="datatype"
                        message="The data type for the observable property. This is required."
                        items={{ datatype: '(str) e.g: "float"' }}
                    />
                </label>
                <input
                    className={`form-input ${descriptionTransition ? 'form-input-error' : 'form-input-error-fade'}`}
                    ...
                    type="text"
                    name="datatype"
                    value={state.datatype? state.datatype : ''}
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                        handleChange(e, setChanges, setState, state, formData)
                    }
                />
...
export default WriteOberservableProperty;