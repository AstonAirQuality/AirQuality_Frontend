...
const SensorPlatformTable: React.FC<SensorPlatformTableProps> = ({
    tableRefresh,
    setTableRefresh,
    setMenuOpen,
    ...
    const tableType = "sensor-platform";
                        ...
                        <div className="flex justify-between items-center p-3 rounded-t border-b dark:border-gray-600">
                            ...
                            {(user?.role === "admin" || user?.role === "sensortech") && (
                                <div className="flex flex-col">
                                    ...
                                    <button
                                        onClick={() => setMenuOpen(addBtnMenuPath + "-Plume")}
                                        className="table-create-button"
                                    >
                                        Create New Plume Sensor Platform
                                    </button>
                                    <button
                                        onClick={() =>
                                            setMenuOpen(addBtnMenuPath + "-DataIngestionTask")
                                        }
                                        className="table-view-map-button"
                                    >
                                        Schedule Data Ingestion Task
                                    </button>
                                </div>
                            )}
                        </div>
...
export default SensorPlatformTable;
